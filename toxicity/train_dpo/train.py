...
def main(config: DictConfig):
    ...
    is_gemma = "gemma" in config.model.name_or_path.lower()
    is_llama = "llama" in config.model.name_or_path.lower()

    # Load the model with appropriate attention implementation
